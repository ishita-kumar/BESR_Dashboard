...
mapboxgl.accessToken =
  "pk.eyJ1IjoiaXNoa3VtYXIiLCJhIjoiY2thN3Fucm10MDZycTJwbzVsZGhkZDZkYyJ9.ZMMsGounuGq3S56MEsEFmw";
var COLORS =
      ...
      map.on("mousemove", function (e) {
        ...
        if (features.length) {
          ...
          document.getElementById("tooltip").innerHTML =
            "" + features[0].properties.CLAIMANTS;
          document.getElementById("tooltip-1").innerHTML =
            "" + features[0].properties.POPULATION;
          document.getElementById("tooltip-2").innerHTML =
            "" +
            Number(
              Math.round(features[0].properties.PERCENTAGE + "e2") + "e-2"
            ) +
            "%";
          document.getElementById("tooltip-3").innerHTML =
            "" + features[0].properties.MEDIAN_HOUSEHOLD;
          document.getElementById("tooltip-4").innerHTML =
            "" + features[0].properties.MEDIAN_HOME;
          document.getElementById("tooltip-5").innerHTML =
            "" + features[0].properties.MEDIAN_FAMILY;
