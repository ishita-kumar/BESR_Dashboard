...
class Map extends React.Component {
  ...
  componentDidMount() {
    const map = new mapboxgl.Map({
      ...
      style: 'mapbox://styles/ishkumar/ckaebnm1r1a5o1imrha754k6l',
    ...
    map.on('load', function () {
      ...
      map.on("mousemove", function (e) {
        ...
        if (features.length) {
            ...
            document.getElementById('tooltip-name').innerHTML = "Tract " + features[0].properties.TRACTCE;
            document.getElementById('tooltip').innerHTML = "Claimants " + features[0].properties.CLAIMANTS;
            document.getElementById('tooltip-1').innerHTML = "Total Population " + features[0].properties.POPULATION;

            document.getElementById('tooltip-2').innerHTML = "Total Percentage " + Number(Math.round((features[0].properties.PERCENTAGE+'e2'))+'e-2') +"%";
